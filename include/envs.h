...
static char *afl_environment_variables[] = {
    ...
    "AFL_PASSTHROUGH",
    "AFL_PATH",
    "AFL_PATH_PROFILING", // [PATH_PROFILING] added to prevent the Mistyped env var warning
    "AFL_SELECTIVE_PATH_PROFILING", // [PATH_PROFILING] added to prevent the Mistyped env var warning
