...
[ ! -e gdk-pixbuf-2.31.1.zip ] && wget https://github.com/unifuzz/unibench/raw/master/gdk-pixbuf-2.31.1.zip
[ ! -e gdk-pixbuf-2.31.1/ ] && unzip -q gdk-pixbuf-2.31.1.zip
[ ! -e SRC/ ] && mv gdk-pixbuf-2.31.1/ SRC
...
cp BUILD/gdk-pixbuf/gdk-pixbuf-pixdata target.afl
...
if [[ $2 == "-nc" ]]; then
  ...
  cp BUILD_C/gdk-pixbuf/gdk-pixbuf-pixdata target.cmplog
