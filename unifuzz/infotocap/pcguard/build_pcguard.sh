...
[ ! -e ncurses-6.1.tar.gz ] && wget https://github.com/unifuzz/unibench/raw/master/ncurses-6.1.tar.gz
[ ! -e ncurses-6.1/ ] && tar zxf ncurses-6.1.tar.gz
[ ! -e SRC/ ] && mv ncurses-6.1/ SRC
...
if [[ $2 == "-nc" ]]; then
  ...
  cp BUILD/progs/tic target.cmplog
