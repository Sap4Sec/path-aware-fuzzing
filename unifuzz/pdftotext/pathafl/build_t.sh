...
pushd $SRC/freetype
./autogen.sh
./configure --prefix="$PREFIX" --disable-shared PKG_CONFIG_PATH="$PKG_CONFIG_PATH" --with-png=no --with-zlib=no --with-harfbuzz=no
make -j$(nproc)
make install
popd
...
#      ./xpdf/libtestXpdfStatic.a ./fofi/libfofi.a ./goo/libgoo.a ./splash/libsplash.a ./xpdf/libtestXpdfWidgetStatic.a ${PREFIX}/lib/libfreetype.a \
#      -I../ -I../goo -I../fofi -I. -I../xpdf -I../splash $LDFLAGS
#done
#
